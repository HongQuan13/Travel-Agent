...
function FinalPlan() {
  ...
  const response = `{"isFinalized": true, "mainHead": "2-Day Trip to India", "subHeaders": {"Day 1: Exploring Delhi": [{"placeName": "Red Fort", "location": "Delhi, India", "description": "Start your day with a visit to this iconic UNESCO World Heritage site.", "images": 
["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRN7fIsq7JVP045499zcXJmse5_m0RTXbXkxrlRbQ-Bm_mJMpkEMFep6aqOow&s",
  ...
  return (
    <Card className="h-full border-0 rounded-none">
      <CardContent className="p-6 overflow-auto max-h-full">
        {[detailPlan].map((plan: any, index: number) => (
          <div key={index}>
